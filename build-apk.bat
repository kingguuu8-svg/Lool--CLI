...
if exist "%ANDROID_DIR%\app\build\outputs\apk\debug\PocketCLI-Mobile-v%APP_VERSION%-debug.apk" (
  copy /y "%ANDROID_DIR%\app\build\outputs\apk\debug\PocketCLI-Mobile-v%APP_VERSION%-debug.apk" "%DIST_DIR%\PocketCLI-Mobile-v%APP_VERSION%-debug.apk" >nul
)
...
if exist "%ANDROID_DIR%\app\build\outputs\apk\release\PocketCLI-Mobile-v%APP_VERSION%-release.apk" (
  copy /y "%ANDROID_DIR%\app\build\outputs\apk\release\PocketCLI-Mobile-v%APP_VERSION%-release.apk" "%DIST_DIR%\PocketCLI-Mobile-v%APP_VERSION%-release.apk" >nul
)
...
echo.
echo APK outputs:
if exist "%DIST_DIR%\PocketCLI-Mobile-v%APP_VERSION%-debug.apk" echo   %DIST_DIR%\PocketCLI-Mobile-v%APP_VERSION%-debug.apk
if exist "%DIST_DIR%\app-debug.apk" echo   %DIST_DIR%\app-debug.apk
if exist "%DIST_DIR%\PocketCLI-Mobile-v%APP_VERSION%-release.apk" echo   %DIST_DIR%\PocketCLI-Mobile-v%APP_VERSION%-release.apk
